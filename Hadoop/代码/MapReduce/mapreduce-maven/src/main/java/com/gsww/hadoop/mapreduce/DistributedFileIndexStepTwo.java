 ...
 * @Description
 */
public class DistributedFileIndexStepTwo {
    /**
     * CDH Hadoop集群配置
     */
...
//        conf.set("mapreduce.app-submission.cross-platform","true");
    ...
    static class DistributedFileIndexStepTwoMapper extends Mapper<LongWritable, Text, Text, Text> {
        Text kOut = new Text();
        Text vOut = new Text();
        ...
        protected void map(LongWritable key, Text value, Context context) throws IOException, InterruptedException {
            ...
            //按“-->”将文本字符串切割为字符串数组：例如：[hello,a.txt   3]
    ...
    static class DistributedFileIndexStepTwoReducer extends Reducer<Text, Text, Text, Text> {
        Text vOut = new Text();
    ...
    public static void main(String[] args) throws IOException, ClassNotFoundException, InterruptedException, URISyntaxException {
        ...
        job.setMapperClass(DistributedFileIndexStepTwoMapper.class);
        job.setReducerClass(DistributedFileIndexStepTwoReducer.class);
