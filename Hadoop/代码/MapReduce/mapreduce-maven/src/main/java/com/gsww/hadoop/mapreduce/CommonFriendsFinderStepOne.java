...
import com.gsww.hadoop.mapreduce.DistributedFileIndexStepOne.DistributedFileIndexStepOneMapper;
import com.gsww.hadoop.mapreduce.DistributedFileIndexStepOne.DistributedFileIndexStepOneReducer;
 ...
 * ...
 *
 * //找出A、B、C...是哪些人的共同好友（第一阶段Reducer的输出）
 * A	B,C,D,F,G,H,I,K,O
 * B	A,E,F,J
 *
 * //第二阶段Mapper输出
 ...
 * @Description
 */
public class CommonFriendsFinderStepOne {
    /**
     * CDH Hadoop集群配置
     */
...
//        System.setProperty("hadoop.home.dir", "D:\\JAVA\\IdeaProjects\\hadoop\\win7-hadoop\\hadoop-2.6.0");
        ...
        PropertyConfigurator.configure("D:/JAVA/IdeaProjects/hadoop/mapreduce-maven/src/main/resources/hadoop/CDH6.0.0/log4j.properties");

        conf = new Configuration();

        //配置文件系统为HDFS
        conf.set("fs.defaultFS","hdfs://utility:8020");
        //伪分布式文件系统
...
//        conf.set("mapreduce.framework.name","local");
        ...
        // 添加Hadoop配置文件
        conf.addResource("hadoop/CDH6.0.0/hdfs-site.xml");
        conf.addResource("hadoop/CDH6.0.0/core-site.xml");
        conf.addResource("hadoop/CDH6.0.0/mapred-site.xml");
        conf.addResource("hadoop/CDH6.0.0/yarn-site.xml");
    ...
    static class CommonFriendsFinderStepOneMapper extends Mapper<LongWritable,Text, Text,Text> {
    ...
    static class CommonFriendsFinderStepOneReducer extends Reducer<Text,Text,Text,Text> {
        Text vOut = new Text();
        @Override
        protected void reduce(Text key, Iterable<Text> values, Context context) throws IOException, InterruptedException {
            ...
            //去除“A	I,K,C,B,G,F,H,O,D,”中的最后一个逗号
    ...
    public static void main(String[] args) throws IOException, ClassNotFoundException, InterruptedException, URISyntaxException {
        ...
        job.setMapperClass(CommonFriendsFinderStepOneMapper.class);
        job.setReducerClass(CommonFriendsFinderStepOneReducer.class);
