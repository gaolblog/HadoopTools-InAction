...
import com.gsww.hadoop.mapreduce.CommonFriendsFinderStepOne.CommonFriendsFinderStepOneMapper;
import com.gsww.hadoop.mapreduce.CommonFriendsFinderStepOne.CommonFriendsFinderStepOneReducer;
 ...
 * @Description
 */
public class CommonFriendsFinderStepTwo {
    /**
     * CDH Hadoop集群配置
     */
...
//        conf.set("mapreduce.framework.name","local");
    ...
    static class CommonFriendsFinderStepTwoMapper extends Mapper<LongWritable, Text, Text,Text> {
        Text kOut = new Text();
        Text vOut = new Text();
        @Override
        protected void map(LongWritable key, Text value, Context context) throws IOException, InterruptedException {
            ...
            //排序people数组
            Arrays.sort(people);
            //people数组中的person两两配对
            for (int i = 0; i < people.length-1; i++) {
                for (int j = i+1; j < people.length; j++) {
                    StringBuilder sb = new StringBuilder();
                    sb.append(people[i] + "-" + people[j]);
                    kOut.set(sb.toString());
    ...
    static class CommonFriendsFinderStepTwoReducer extends Reducer<Text,Text,Text,Text> {
        Text kOut = new Text();
        Text vOut = new Text();
        @Override
    ...
    public static void main(String[] args) throws IOException, ClassNotFoundException, InterruptedException, URISyntaxException {
        ...
        job.setMapperClass(CommonFriendsFinderStepTwoMapper.class);
        job.setReducerClass(CommonFriendsFinderStepTwoReducer.class);
